	...
	<div class="header">
		...
		<div class="container">
			<div class="h_menu4">
				...
				<ul class="nav">
					<li class="active"><a href="/index"><i> </i>Desktops</a></li>
			  ...
			  <li><img src="images/banner2.jpg" alt="">
				...
				<div class="banner-bottom">
					<div class="banner-matter">
						...
						<a href="/single" class="hvr-shutter-in-vertical ">Purchase</a>
					</div>
					<div class="purchase">
						<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2 ">Purchase</a>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>				
				...
				<div class="content-top">
					...
					<div class="content-top-in">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single"><img  src="images/pi.jpg" alt="" /></a>	
								<div class="top-content">
									<h5><a href="/single">Mascot Kitty - White</a></h5>
									<div class="white">
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single"><img  src="images/pi1.jpg" alt="" />	</a>
								<div class="top-content">
									<h5><a href="/single">Bite Me</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single"><img  src="images/pi2.jpg" alt="" /></a>	
								<div class="top-content">
									<h5><a href="/single">Little Fella</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single"><img  src="images/pi3.jpg" alt="" /></a>	
								<div class="top-content">
									<h5><a href="/single">Astral Cruise</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
				...
				<div class="content-bottom">
					...
					<ul id="flexiselDemo2">			
						<li><div class="col-md men">
								<a href="/single" class="compare-in "><img  src="images/pi4.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div></a>
								<div class="top-content bag">
									<h5><a href="/single">Symbolic Bag</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<li><div class="col-md men">
								<a href="/single" class="compare-in "><img  src="images/pi5.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div></a>	
								<div class="top-content bag">
									<h5><a href="/single">Interesting Read</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<li><div class="col-md men">
								<a href="/single" class="compare-in "><img  src="images/pi6.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div></a>	
								<div class="top-content bag">
									<h5><a href="/single">The Carter</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<li><div class="col-md men">
								<a href="/single" class="compare-in "><img  src="images/pi7.jpg" alt="" />
								<div class="compare in-compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div></a>	
								<div class="top-content bag">
									<h5><a href="/single">Onesie</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
