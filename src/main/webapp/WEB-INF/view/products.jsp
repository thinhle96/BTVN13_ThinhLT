	...
	<div class="header">
		...
		<div class="container">
			<div class="h_menu4">
				...
				<ul class="nav">
					<li ><a href="/index"><i> </i>Desktops</a></li>
					<li class="active"><a href="#" >Laptops & Notebooks</a>
						<ul class="drop">
							<li><a href="/products">Sony(2)</a></li>
							<li><a href="/products">Android(4)</a></li>
							<li><a href="/products">Apple(7)</a></li>
							<li><a href="/products">Acer(53)</a></li>
							<li><a href="/products">HP(78)</a></li>
							<li><a href="/products">Intel(5)</a></li>
						</ul>
						</li> 						
						<li><a href="/products" >  Tablets</a></li>            
						<li><a href="/products" >Components</a></li>						  				 
						<li><a href="/products" >Software</a></li>
						<li><a href="/products" >Phones & PDAs </a></li>
			...
			<div class="products">
					...
					<div class=" top-products">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic.jpg" alt="" />
								<div class="compare">
								...
								<div class="top-content">
									<h5><a href="/single">Popular belief</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic1.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
								...
								<div class="top-content">
									<h5><a href="/single" >Simply random</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic2.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
								...
								<div class="top-content">
									<h5> <a href="/single">Classical Latin</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic3.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
								...
								<div class="top-content">
									<h5><a href="/single">Standard chunk</a></h5>
									<div class="white">
										<a href="/single" class="hvr-shutter-in-vertical hvr-shutter-in-vertical2">ADD TO CART</a>
					...
					<div class=" top-products">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic4.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic5.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md ">
								<a href="/single" class="compare-in"><img  src="images/pic6.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md ">
								<a href="/single" class="compare-in"><img  src="images/pic7.jpg" alt="" />	
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
					...
					<div class="top-products">
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in" ><img  src="images/pic8.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic9.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic10.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
						...
						<div class="col-md-3 md-col">
							<div class="col-md">
								<a href="/single" class="compare-in"><img  src="images/pic11.jpg" alt="" />
								<div class="compare">
									<span>Add to Compare</span>
									<span>Add to Whislist</span>
								</div>
